...
export const mathCurrentTerm: LessonContent[] = [
  {
    ...
    lowEnergyTask: { title: "数学低电量启动", steps: ["看1道小数加减题", "只说这题先看哪里", "不用完整计算"], outputRequirement: "说1句话", estimatedMinutes: 5 },
    normalTask: { title: "数学讲清楚小局", steps: ["做1道小数加减题", "讲清为什么小数点对齐", "估算检查一次", "写下1个错因"], outputRequirement: "做1题 + 讲清楚第一步", estimatedMinutes: 12 },
    challengeTask: { title: "小数点侦探", steps: ["做2道同类题", "故意找1个可能错因", "自己编1道小数点陷阱题"], outputRequirement: "2题 + 1个错因 + 1道自编题", estimatedMinutes: 20 },
  ...
  },
  {
    ...
    lowEnergyTask: { title: "三角形低电量启动", steps: ["看3条边", "只判断能不能围成三角形", "说一句理由"], outputRequirement: "判断 + 1句话", estimatedMinutes: 6 },
    normalTask: { title: "三角形侦探小局", steps: ["判断1组三边", "说清用的是哪条规则", "画一个小图", "记录1个易错点"], outputRequirement: "判断1题 + 讲清规则", estimatedMinutes: 12 },
    challengeTask: { title: "三角形陷阱题", steps: ["做2道判断题", "找1个陷阱", "自己编1组不能围成三角形的边长"], outputRequirement: "2题 + 1个陷阱", estimatedMinutes: 20 },
