...
export const defaultTasks = [
  {
    ...
    type: "数学",
    title: "数学期末复习",
    detail: "6月主线：小数、三角形、运算律和统计。每天只做一个考点的小回合，最后抓一个陷阱。",
    target: "今日建议：10道小数计算/简便运算 + 2道三角形或统计题。只改：圈关键词、单位、进退位、画图，选一个。",
    icap: "A"
  },
  {
    id: "english",
    ...
    type: "英语",
    title: "英语期末复习",
    detail: "6月主线：四下课本核心词句、问答句、易混词。先能说出来，再改一个语法点。",
    target: "今日建议：听读1段 + 3组问答 + 3句输出。只改：where/when、the/they/their、首字母、because，选一个。",
    icap: "A"
  },
  {
    id: "chinese",
    ...
    type: "语文",
    title: "语文期末复习",
    detail: "6月主线：古诗文、课内阅读、词语句子、习作素材。先看见画面，再留下标准表达。",
    target: "今日建议：1首古诗/文言 + 1篇课内阅读片段 + 3个词句。只改：画面、关键词、中心句、写具体，选一个。",
    icap: "A"
  },
  {
    id: "harmonica",
...
export const finalReviewPlan = {
  title: "6月期末最后一个月复习",
  period: "2026年6月",
  principle: "主科优先、短回合、每天留痕。数学抓错因，语文抓课内和表达，英语抓能说出口的核心句。",
  weeks: [
    {
      name: "第1周：补漏洞",
      range: "6月1日-6月7日",
      focus: ["数学：小数意义、性质、加减法、四则运算错因", "语文：古诗文和课内重点词句", "英语：where/when、the/they/their、核心问答句"],
      daily: "每天每科只做一小组，错题必须说出错因。"
    },
    {
      name: "第2周：单元轮转",
      range: "6月8日-6月14日",
      focus: ["数学：运算律、三角形、观察物体、图形运动", "语文：课内阅读、概括、修辞和句式", "英语：精通四下单元词句复现，朗文做听说补充"],
      daily: "每天一个主单元，结束时让八宝当教练抓一处陷阱。"
    },
    {
      name: "第3周：综合卷感",
      range: "6月15日-6月21日",
      focus: ["数学：综合小卷，审题和时间感", "语文：阅读题思路和习作素材", "英语：听读、看图说话、三句输出"],
      daily: "练卷感但不堆量，重点看重复错因。"
    },
    {
      name: "第4周：轻量冲刺",
      range: "6月22日-6月30日",
      focus: ["数学：错题本和高频陷阱", "语文：古诗文、词句、作文开头结尾", "英语：核心词句、易混点、朗读流畅"],
      daily: "少做新难题，多做熟练度和信心。"
    }
  ],
  dailyTemplate: [
    "数学 20分钟：10道计算/简算 + 2道图形/统计/应用题，记录1个错因。",
    "语文 20分钟：1个课内点 + 1段阅读 + 1句写具体，避免大段抄写。",
    "英语 15分钟：听读 + 3组问答 + 3句输出，只改一个易混点。",
    "口琴 5分钟：只练最乱的4-8小节。",
    "网球 10分钟：只练一个动作点。"
  ],
  subjectTracks: {
    ...
    english: ["精通四下核心词句", "where/when", "the/they/their", "问答句", "朗读流畅", "3句输出", "朗文生活场景复现"]
  }
};
