...
export const exampleBank = {
  math: [
    {
      point: "小数加减法",
      prompt: "完整题目：八宝今天练网球，第一组训练用了37.6分钟，第二组比第一组少8.75分钟，后来又加练12.4分钟。请写出完整算式：37.6 - 8.75 + 12.4，并算出一共对应多少分钟。",
      hint: "先写“要求什么”，再把小数点对齐。重点抓：8.75 和 12.4 的位数不同，不能只看数字末尾。",
      answer: "37.6 - 8.75 + 12.4 = 41.25，所以是41.25分钟。"
    },
    {
      point: "运算律",
      prompt: "完整题目：一盒训练球有125个，学校准备了32盒；每个训练区再按25组统计。请用简便方法计算：125 x 32 x 25，并写出你把32拆成什么。",
      hint: "把32拆成8 x 4，让125 x 8、25 x 4先配对。请写清楚每一步，不只写答案。",
      answer: "125 x 32 x 25 = 125 x 8 x 4 x 25 = 1000 x 100 = 100000。"
    },
    {
      point: "三角形",
      prompt: "完整题目：一个三角形已经知道两条边分别是6 cm和9 cm。第三条边从3 cm、8 cm、16 cm里选。请判断哪一个能和6 cm、9 cm围成三角形，并写出理由。",
      hint: "第三边要大于两边之差3 cm，小于两边之和15 cm。把每个选项都比一下。",
      answer: "8 cm。因为3 < 8 < 15；3 cm等于两边之差，16 cm大于两边之和，都不行。"
    },
    {
      point: "平均数",
      prompt: "完整题目：八宝做了4次发球训练，命中数分别是7个、9个、8个、10个。请先求总命中数，再求平均每次命中几个。",
      hint: "先写总数：7 + 9 + 8 + 10，再除以4。平均数可以是小数。",
      answer: "(7 + 9 + 8 + 10) ÷ 4 = 34 ÷ 4 = 8.5，所以平均每次命中8.5个。"
    },
    {
      point: "审题陷阱",
      prompt: "完整题目：一根绳子原来长12.5米，先用去3.8米，后来又接上2.35米。请判断哪一步是减法、哪一步是加法，并求现在绳子长多少米。",
      hint: "“用去”是减，“接上”是加。先写完整式子：12.5 - 3.8 + 2.35。",
      answer: "12.5 - 3.8 + 2.35 = 11.05，所以现在长11.05米。"
    }
  ],
  chinese: [
    {
