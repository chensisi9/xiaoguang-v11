export const curriculumLessons = [
  {
    ...
    lowEnergyTask: {
      title: "数学低电量启动",
      steps: ["看这道题：12.5 - 3.8 + 2.35", "说清题目要求：原来、用去、接上分别是什么意思", "只说第一步先算什么，不用完整计算"],
      outputRequirement: "完整说1句话：这题要求___，我第一步先___。",
      estimatedMinutes: 5
    },
    normalTask: {
      title: "数学讲清楚小局",
      steps: ["完整读题：一根绳子原来12.5米，用去3.8米，又接上2.35米，现在长多少米", "写完整算式：12.5 - 3.8 + 2.35", "讲清为什么小数点要对齐", "估算检查一次，并写下1个可能错因"],
      outputRequirement: "完整表达：题目要求什么 + 算式 + 答案 + 为什么这样算",
      estimatedMinutes: 12
    },
    challengeTask: {
      title: "小数点侦探",
      steps: ["做2道同类题：37.6 - 8.75 + 12.4；12.5 - 3.8 + 2.35", "每道题说清“要求什么”再计算", "故意找1个可能错因", "自己编1道小数点陷阱题"],
      outputRequirement: "2题完整表达 + 1个错因 + 1道自编题",
      estimatedMinutes: 20
    },
  ...
  },
  {
    ...
    lowEnergyTask: {
      title: "三角形低电量启动",
      steps: ["看这组三边：6 cm、9 cm、8 cm", "判断能不能围成三角形", "说一句理由：最短两边相加要大于最长边"],
      outputRequirement: "完整说：6、9、8能/不能围成三角形，因为___。",
      estimatedMinutes: 6
    },
    normalTask: {
      title: "三角形侦探小局",
      steps: ["完整读题：第三条边从3 cm、8 cm、16 cm里选，哪一个能和6 cm、9 cm围成三角形", "分别判断3、8、16三个选项", "说清用的是哪条规则", "记录1个易错点"],
      outputRequirement: "完整表达：我选___，因为第三边要大于___并且小于___。",
      estimatedMinutes: 12
    },
    challengeTask: {
      title: "三角形陷阱题",
      steps: ["做2道判断题：6、9、8；6、9、16", "每题都说清最短两边相加和最长边的关系", "找1个陷阱", "自己编1组不能围成三角形的边长"],
      outputRequirement: "2题完整判断 + 1个陷阱",
      estimatedMinutes: 20
    },
